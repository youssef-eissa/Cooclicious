        ...
        <div className='row footer'>
            <div className='col-12 d-flex flex-column flex-md-row up pb-3'>
                <div className='col-md-3 col-12 d-flex flex-column'>
                    <Link reloadDocument to='/cooclicious/' onClick={()=>window.scrollTo({top:0,behavior:'smooth'})} className='col-12 link' style={{ fontFamily: 'Pirata One, cursive' }}>Cooclicious</Link>
